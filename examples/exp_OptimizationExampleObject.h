...
class exp_OptimizationExampleObject : public TObject
{
  T_OBJECT;

public:
  exp_OptimizationExampleObject(QString object_n = "", TObject *iparent = NULL);
  virtual ~exp_OptimizationExampleObject() {}
