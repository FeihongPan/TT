...
class T_EXPORT_EXAMPLES exp_CurveToplogyExampleObject : public TObject
{
  T_OBJECT;

public:
  exp_CurveToplogyExampleObject(QString object_n = "", TObject *iparent = NULL);
  virtual ~exp_CurveToplogyExampleObject() {}

public:
  curve_Topology* getTopology1();
  curve_Topology* getTopology2();
  curve_Topology* getTopology3();
};
